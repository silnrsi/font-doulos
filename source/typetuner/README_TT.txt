...
Note: This package contains a TypeTuned version of the Doulos SIL fonts. The TypeTuner settings file used to generate the enclosed font is included in the package as DoulosSIL-feat_set_tuned.xml. By inspecting this file with a text editor you can determine which alternate behaviors have been enabled.
