...
Both desktop and web fonts are provided in a single, all-platforms package on the [Download page](http://software.sil.org/doulos/download). Special-purpose fonts are available from a [dedicated page](https://software.sil.org/lcgfonts/download/).
